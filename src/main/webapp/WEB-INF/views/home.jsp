	...
	<div class="carousel-inner" role="listbox">
		...
		<c:forEach var="result" items="${bannerList}" varStatus="st">
			<div class="item <c:if test="${cnt == 1 }">active</c:if>">
				<img src="/common/img?fName=${result.stored_file_name}&folder=${result.folder_nm}" alt="carousel1" style="width: 100%; height: 80%" />
				<div class="carousel-caption">
					<div class="row">
						...
						<div class="col-md-5">
							...
							<br />
							<a href="/adoption/animal/list"><button type="button" class="button-more-primary btn btn-lg" type="button" style="margin:10px;">READ MORE</button></a>
						</div>
					</div>
				</div>
			</div>
