            ...
            <form role="form" action="/adoption/animal/information/modify" method="post" enctype="multipart/form-data">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <th>
                            <label class="radio-inline"><input type="radio" name="adoptionStatus" value="Y" <c:if test="${modify.adoptionStatus == 'Y'}">checked</c:if>> 가능</label>
                            <label class="radio-inline"><input type="radio" name="adoptionStatus" value="N" <c:if test="${modify.adoptionStatus == 'N'}">checked</c:if>> 불가능</label>
                        </th>
                    </tr>
                    <tr>
                        <td class="bold" >동물 이름</td>
                        <td><input type="text" class="form-control" name="animal_name" value="${modify.animal_name}"></td>
                        <td class="bold" >종</td>
                        <td><input type="text" class="form-control" name="species" value="${modify.species}"></td>
                        ...
                        <td><input type="text" class="form-control" name="iLike" value="${modify.ILike}"></td>
                    </tr>
                    <tr>
                        <td class="bold" >나이</td>
                        <td><input type="text" class="form-control" name="age" value="${modify.age}"></td>
                        <td class="bold" >성별</td>
                        <td>
                        ...
                        <td><input type="text" class="form-control" name="inoculation" value="${modify.inoculation}"></td>
                        <td class="bold" >싫어하는 것</td>
                        <td><input type="text" class="form-control" name="disLike" value="${modify.disLike}"></td>
                    </tr>
                    <tr>
                        <td class="bold" >상세 내용</td>
                        <td colspan="7"><textarea class="form-control" rows="5" name="content">${modify.content}</textarea></td>
                    </tr>
                    </tbody>
                </table>
